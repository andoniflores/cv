...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: AWS, Postman, Git(GitHub)} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed and maintained web applications mainly for the Atlassian marketplace, using Python, Flask, ReactJS, AWS, and CSS.}
