...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Fixed long awaited community bugs that involved knowledge of the Unity client to the backend server using C\# and .NET, contributing to raise the game polish 
        and lowered gameplay frustration.}
